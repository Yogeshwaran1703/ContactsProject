...
namespace KnilaAPI.Services
{
    public class ContactService : IContactService
    {
        ...
        public async Task<List<CityDTO>> GetCities()
        {
            ...
            cityDetails = await (from C in _context.TblCities
                                 select new CityDTO
                                 {
                                     CityId = C.CityId,
                                     CityName = C.CityName
        ...
        {
            List<StateDTO> stateDetails = new List<StateDTO>();

            stateDetails = await (from C in _context.TblStates
                                  select new StateDTO
                                  {
                                      StateId = C.StateId,
        ...
        {
            List<CountryDTO> cityDetails = new List<CountryDTO>();

            cityDetails = await (from C in _context.TblCountries
